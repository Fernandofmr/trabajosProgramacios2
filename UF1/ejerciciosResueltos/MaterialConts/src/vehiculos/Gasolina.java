...
/* Declaración de la clase Gasolina, que hereda de Vehiculo 
e implementa GestionVehiculo gracias a esa herencia */

public class Gasolina extends Vehiculo{ 
	
	// Declaración de las variables própias de la clase
	...
	public Gasolina(String marca, double velocidad_actual, boolean arrancado, double precio, 
